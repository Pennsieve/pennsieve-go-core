...
func (q *Queries) GetTokenByCognitoId(ctx context.Context, id string) (*models.Token, error) {
...
func (q *Queries) GetUserByCognitoId(ctx context.Context, id string) (*models.User, error) {
